...
class GiteaCommitMessageProcessor:
    def __init__(self, api_url: str, data_folder="../data/processed"):
        ...
        self.issue_api = giteapy.IssueApi(giteapy.ApiClient(self.configuration))
    ...
    def extract_xcm(self, org: str, repo_name: str) -> list :
        ...
        for sha in self.commits_df.index:
            ...
            if issue_identifier:
                try:
                    issue = self.issue_api.issue_get_issue(owner=org, repo = repo_name, index=issue_identifier)
